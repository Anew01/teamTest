    ...
    <%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
        <% Member loginMember=(Member) session.getAttribute("m"); %>
            ...
            <head>
                ...
                <link href="https://fonts.googleapis.com/css2?family=Lobster&family=Nanum+Gothic&display=swap"
                    rel="stylesheet">
                    ...
                    <div class="sidebar">
                        <div class="sidebar-menu">
                            ...
                            <li class="item" id="settings">
                                ...
                                <div class="sub-menu">
                                    <a href="/noticeWriteFrm.do"><i class="fa-solid fa-pen-nib"></i><span>공지사항
                                            작성</span></a>
                                    <a href="/noticeList.do?reqPage=1"><i class="fa-solid fa-list"></i><span>공지사항
                                            목록</span></a>
                                </div>
                            </li>
                            <li class="item">
