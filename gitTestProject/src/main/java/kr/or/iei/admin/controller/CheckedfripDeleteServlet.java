...
@WebServlet(name = "CheckedfripDelete", urlPatterns = { "/checkedfripDelete.do" })
public class CheckedfripDeleteServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	public CheckedfripDeleteServlet() {
		super();
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		boolean result = service.checkedfripDelete(fripNos);

		RequestDispatcher view = request.getRequestDispatcher("/WEB-INF/views/common/msg.jsp");

		if (result) {
			request.setAttribute("title", "프립 삭제 성공");
