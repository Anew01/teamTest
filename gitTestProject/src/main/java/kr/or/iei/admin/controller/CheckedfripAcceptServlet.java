...
@WebServlet(name = "CheckedfripAccept", urlPatterns = { "/checkedfripAccept.do" })
public class CheckedfripAcceptServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	public CheckedfripAcceptServlet() {
		super();
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		boolean result = service.checkedfripAccept(fripNos);

		RequestDispatcher view = request.getRequestDispatcher("/WEB-INF/views/common/msg.jsp");

		if (result) {
			request.setAttribute("title", "프립 수락 성공");
